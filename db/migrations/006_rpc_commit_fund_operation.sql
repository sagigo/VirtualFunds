-- ============================================================
-- Migration 006: rpc_commit_fund_operation (E6.7)
-- Core engine for deposit, withdrawal, transfer, revalue, undo
-- ============================================================
...
REVOKE ALL ON FUNCTION public.rpc_commit_fund_operation(uuid, uuid, uuid, text, text, text, uuid, text, text, jsonb) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.rpc_commit_fund_operation(uuid, uuid, uuid, text, text, text, uuid, text, text, jsonb) FROM anon;
GRANT EXECUTE ON FUNCTION public.rpc_commit_fund_operation(uuid, uuid, uuid, text, text, text, uuid, text, text, jsonb) TO authenticated;
